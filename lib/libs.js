...
if (process.env.OPENBLAS_LIB_DIR) {
  console.log('-L' + process.env.OPENBLAS_LIB_DIR)
  console.log('-lopenblas')
}

if (process.env.CUDA_LIB_DIR) {
  console.log('-L' + process.env.CUDA_LIB_DIR)
  console.log('-lcudart')
  console.log('-lcublas')
}

if (process.env.CUDNN_LIB_DIR) {
  console.log('-L' + process.env.CUDNN_LIB_DIR)
  console.log('-lcudnn')
}

if (process.env.FACERECOGNITION_CUSTOM_LIBS) {
  console.log(process.env.FACERECOGNITION_CUSTOM_LIBS)
}
